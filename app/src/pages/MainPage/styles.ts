const styles = {
    ...
    inputs: "w-full rounded-lg bg-slate-800 border border-slate-700 px-3 py-2 text-sm outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500",
    spacing: "space-y-2",
    postbase: "w-full max-w-lg bg-slate-900 border border-slate-800 rounded-2xl shadow-xl p-6 space-y-6",
    purpleBtn: "rounded-lg bg-indigo-600 hover:bg-indigo-500 transition-colors px-3 py-2 text-sm font-medium cursor-pointer",
